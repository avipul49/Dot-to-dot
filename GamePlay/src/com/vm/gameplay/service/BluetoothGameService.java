...
public class BluetoothGameService {
	...
	public static BluetoothGameService instance;

	public static BluetoothGameService getInstance(Context context) {
		if (instance == null) {
			instance = new BluetoothGameService(context);
		}
		return instance;
	}

	private BluetoothGameService(Context context) {
	...
	private synchronized void setState(int state) {
		...
		intent.setAction(FindGameActivity.STR_MESSAGE_STATE_CHANGE);
	...
	public synchronized void connected(BluetoothSocket socket,
		...
		Intent intent = new Intent();
		intent.setAction(FindGameActivity.STR_MESSAGE_DEVICE_NAME);
		intent.putExtra(FindGameActivity.DEVICE_NAME, device.getName());
		mContext.sendBroadcast(intent);
